        ...
        <section className='flex items-center justify-center flex-col md:flex-row gap-8 bg-pattern-bg bg-cover h-full py-10'>
            ...
            <span className='flex gap-y-6'>
                <p className='m-6 text-white text-sm md:text-md max-w-md'> 
                    ...
                    experience in South Africa. {COMPANY_NAME} isn&apos;t just a platform; it&apos;s a manifestation of my commitment to empowering talent, fostering 
                    ...
                    driven by innovation, integrity, and excellence. Our mission at {COMPANY_NAME} is to simplify the complex, to transform the mundane into the extraodinary, and to unlock opportunities that transcend boundaries.
                </p>
            </span>
        </section>
    );
