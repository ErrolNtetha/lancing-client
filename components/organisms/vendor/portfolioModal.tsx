        ...
        <section className='relative p-2 min-h-[80vh]'>
            <section className='p-2'>
                ...
                <section className='pt-4'>
                    ...
                    {/* <section>
                        <p className='flex items-center gap-1 text-sm'> <FiCalendar /> Joined 23 April 2023 </p>
                        <p className='flex items-center gap-1 text-sm'> <FiMap /> <span>Durban, KwaZulu-Natal</span> </p>
                    </section> */}
                </section>
            </section>
