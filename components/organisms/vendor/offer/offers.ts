export const offers = [
    {
        id: '3ifj023jhkjash-dasfjw32d2h23hkgi3fd',
        client: {
            names: {
                firstName: 'John',
                lastName: 'Smith'
        ...
        project_details: {
            title: 'Offer for Web Development',
    ...
    {
        id: 'nj9aonjkawb23ljf-k4fad23hjas3-32j',
        client: {
            names: {
    ...
    {
        id: 'fjd92jlb2hju4-323g23h32-laf9kazi3',
        client: {
            names: {
    ...
    {
        id: 'op9pe4nba8-2j4h53k83kfak82-23kia9',
        client: {
            names: {
                firstName: 'Nicole',
                lastName: 'Pamela'
        ...
        project_details: {
            title: 'Copywrite for Website Landing Page',
